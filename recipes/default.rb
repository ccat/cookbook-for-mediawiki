...
script "set_mediawiki" do
  ...
  sed -e "s/maintenance\\/install.php/#{node[:mediawiki][:url]}/g" LocalSettings_autogenerate.php > LocalSettings.php
  sed -e "/\$wgEmergencyContact/D" LocalSettings.php > LocalSettings.php
  sed -e "/\$wgPasswordSender/D" LocalSettings.php > LocalSettings.php
